...
2. Clone the forked repository
    ...
    cd spotlights
    ```
3. Copy the contributor blog template from `templates/contributor.md` to `content/spotlight/contributor`.

    Name the filename as `<yyyy>-<mm>--<author>--<title>.md`, where `yyyy` and `mm` are the year and month in which you are submitting the pull request with the blog in this repository, `author` is your name and `title` is the title of your blog.

    For example, if your name is "John Doe" and your blog title is "Making my first contribution to TranscribeIt: A beginner's journey", the file name will be `2025-12--john-doe--making-my-first-contribution-to-transcribeit-a-beginners-journey.md` if month is December and year is 2025.
...
2. Clone the forked repository
    ...
    cd spotlights
    ```
3. Copy the mentor blog template from `templates/mentor.md` to `content/spotlight/mentor`.

    Name the filename as `<yyyy>-<mm>--<author>--<title>.md`, where `yyyy` and `mm` are the year and month in which you are submitting the pull request with the blog in this repository, `author` is your name and `title` is the title of your blog.

    For example, if your name is "John Doe" and your blog title is "On mentoring first-time contributors", the file name will be `2025-12--john-doe--on-mentoring-first-time-contributors.md` if month is December and year is 2025.
